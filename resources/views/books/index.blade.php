...
@section('title', 'Buku - Sistem Perpustakaan')
            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center">
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-600">Daftar semua buku di perpustakaan</p>
                    </div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            ...
                                            {{ $book->category ? $book->category->name : 'Tidak ada' }}
                                        </span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
