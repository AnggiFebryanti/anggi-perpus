...
<div class="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-3xl mx-auto">
    ...
    <div class="mb-8">
      ...
      <p class="mt-1 text-sm text-gray-600">Ubah informasi buku</p>
    </div>
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
            ...
            <div class="sm:col-span-2">
              ...
              <div class="mt-2 mb-4 flex items-center">
                <img src="{{ asset('storage/' . $book->cover) }}" alt="{{ $book->title }}" class="h-32 w-24 object-cover rounded">
                <div class="ml-4">
                  <p class="text-sm text-gray-700 font-medium">Cover saat ini</p>
                  <p class="text-xs text-gray-500 mt-1">Upload cover baru untuk menggantinya</p>
                </div>
              </div>
              @endif
            ...
            <div class="flex">
              ...
              <div class="ml-3">
                <h3 class="text-sm font-medium text-gray-900">
                  Buku ini memiliki {{ $book->loans->count() }} riwayat peminjaman
                </h3>
                @if($book->loans()->where('status', 'dipinjam')->count() > 0)
                <p class="mt-1 text-sm text-orange-700">
                  {{ $book->loans()->where('status', 'dipinjam')->count() }} buku sedang dipinjam
                </p>
                @endif
              </div>
            </div>
